...
const _state$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#State', schema: stateSchema, create: () => stateSchema }
const _patch$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#ConfigPatch', schema: patchSchema, create: () => patchSchema }
const _key$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#ModelKey', schema: str, create: () => str }
const _tokens$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#TokenCount', schema: num, create: () => num }
