...
const _state$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#State', create: () => stateSchema }
const _patch$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#ConfigPatch', create: () => patchSchema }
const _key$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#ModelKey', create: () => str }
const _tokens$codec = { mode: 'strict', typeSymbol: 'dsh-token-quota#TokenCount', create: () => num }
